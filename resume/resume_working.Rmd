...
::: concise
- Create annual reports in collaboration with the National Center on Deafblindness
- Led a project predicting student use of text-to-speech function
- Testing student assessment data using Bayesian Networks
:::

### Posit Academy Mentor

RStudio; Posit

Remote

01/22-09/22; 7/23-Present
